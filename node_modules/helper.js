...
exports.renderPage=function(app,res,io,connection,pageName,param)//in js we do not need to give data type of formal parameters in functions
    ...
    case 'index':
    {
      ...
      connection.query("SELECT * FROM friends WHERE uid=?",[param.uid],function(err,results,fields){//getting the uid property of the object
        if(Object.keys(results).length>0)
        {
          ...
          res.render('pageTemplate',{page:pageName});
